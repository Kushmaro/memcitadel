...
- Files: `memcitadel/mcp_server.py` (lines 495-498), `memcitadel/dialect.py`
...
- Files: `memcitadel/mcp_server.py` (lines 182, 200-201, 221, 541), `memcitadel/es_client.py` (lines 254, 416), `memcitadel/miner.py`
...
- Files: `memcitadel/miner.py`, `memcitadel/config.py`, `memcitadel/searcher.py`, `memcitadel/onboarding.py`, `memcitadel/spellcheck.py`, `memcitadel/cli.py`, `memcitadel/mcp_server.py` (127-128), `memcitadel/migrate_to_es.py`
...
- Files: `memcitadel/mcp_server.py` (lines 73-76, 92-94), `memcitadel/config.py`
...
- Files: `memcitadel/mcp_server.py` - tool_check_duplicate (274-275), tool_add_drawer (319, 365), tool_delete_drawer (375, 394), tool_kg_add (415), vs. _no_palace (105-108), tool_search (returns SearchError exception)
...
- Files: `memcitadel/mcp_server.py` (lines 121-128)
...
- Files: `memcitadel/mcp_server.py` (lines 71-96), `/Users/omerkushmaro/.mempalace/wal/write_log.jsonl`
...
- Files: `memcitadel/config.py` (lines 19, 44-45), `memcitadel/mcp_server.py` (lines 315-316)
...
- Files: `memcitadel/mcp_server.py` (all WRITE TOOLS section, lines 307-525)
...
- Files: `memcitadel/mcp_server.py` (lines 182-188, 221-227)
...
- Files: `memcitadel/es_client.py` (line 337)
...
- Files: `memcitadel/mcp_server.py` (lines 80-96)
...
- Files: `memcitadel/knowledge_graph.py` (line 93)
...
- Files: `memcitadel/dialect.py` (1075 lines)
...
- Files: `memcitadel/es_client.py` (lines 33-70)
...
- Files: `memcitadel/dialect.py` (1075 lines) — only positive path tested in `tests/test_dialect.py`
...
- Files: `memcitadel/mcp_server.py` (lines 66-96)
