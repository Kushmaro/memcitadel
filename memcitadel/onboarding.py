...
from memcitadel.entity_registry import EntityRegistry
from memcitadel.entity_detector import detect_entities, scan_for_detection
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from memcitadel.entity_registry import COMMON_ENGLISH_WORDS
